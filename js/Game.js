class Game {
  constructor() {
    ...
    //propriedade de seta para esquerda
  ...
  //criar função para verificar colisão entre obstáculos e carros
  handleObstacleCollision(index) {
    if(cars[index-1].collide(obstacle1) || cars[index-1].collide(obstacle2)) {

    //condicional para mover os carros para longe dos obstáculos
    ...
    //adicionar mensagem quando acabar a vida
